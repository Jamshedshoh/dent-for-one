...
import { Bluetooth, Smartphone, RefreshCw, Plus, Trash2, Battery, Wifi, RotateCw } from "lucide-react";
...
export default function Devices() {
  ...
  const [connectedDevices, setConnectedDevices] = useState([
    { id: 1, name: "SmartBrush X3", type: "Electric Toothbrush", battery: 68, connected: true, lastSync: "Today, 08:32 AM" },
    { id: 2, name: "WaterFlosser Pro", type: "Water Flosser", battery: 45, connected: true, lastSync: "Yesterday, 09:15 PM" }
  ]);
      ...
      <main className="container px-4 py-6">
        ...
        <Card className="mb-6">
          <CardHeader>
            ...
            <CardDescription>Connect your smart dental devices to track your oral health</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex gap-4 flex-col md:flex-row md:items-center">
              <div className="flex-1 space-y-2">
                <p className="text-sm">Make sure your device is turned on and in pairing mode before scanning.</p>
                <p className="text-sm text-muted-foreground">
                  Compatible with most smart toothbrushes, water flossers, and other dental care devices.
                </p>
              </div>
              <Button 
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Manage your connected smart dental devices</CardDescription>
          </CardHeader>
                      ...
                      <div className="flex-1 space-y-2">
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                          ...
                          <div className="flex items-center gap-2 mt-2 md:mt-0">
                            ...
                            />
                            <span className="text-xs">{device.connected ? "Connected" : "Disconnected"}</span>
                          </div>
                        </div>
            ...
            <div className="w-full space-y-2">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-xs text-muted-foreground">Sync device data even when the app is closed</p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-xs text-muted-foreground">Share anonymous usage data to improve our service</p>
                </div>
                <Switch defaultChecked />
              </div>
            </div>
