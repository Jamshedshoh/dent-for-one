...
import { CheckCircle2, Circle, Trophy, TrendingUp, Calendar, MoreHorizontal, AlertCircle } from "lucide-react";
      ...
      <main className="container px-4 py-6">
        ...
        <div className="bg-card rounded-xl shadow-sm p-4 mb-6">
          ...
          <div className="flex justify-between items-center text-xs text-muted-foreground">
            ...
            <span>{points}/{nextLevel} to next level</span>
          </div>
            ...
            {habits.map((habit) => (
              <div 
                ...
                className={cn(
                  ...
                  habit.completed ? "bg-primary/5 border-primary/20" : "bg-card border-border"
                )}
          ...
          <div className="space-y-6">
                    ...
                    <div 
                      className={`w-8 h-8 rounded-full flex items-center justify-center mb-1 ${
                        index < 3 ? "bg-primary text-white" : (
                          index === 3 ? "border-2 border-dashed border-primary text-primary" : "bg-secondary"
                        )
                      }`}
                    >
                      {index < 3 ? "✓" : (index === 3 ? "•" : "")}
            ...
            <div className="bg-card rounded-xl shadow-sm p-4">
              ...
              <div className="p-3 bg-amber-50 rounded-lg flex items-start">
                ...
                <div>
                  <p className="text-sm font-medium text-amber-800">Preparation Tips</p>
                  <p className="text-xs text-amber-700">
                    Continue your good habits to ensure a positive check-up. Don't forget to bring your insurance card.
                  </p>
                </div>
              </div>
            </div>
