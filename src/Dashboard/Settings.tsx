...
export const Settings = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="bg-white p-6 rounded-lg shadow-md">
        <h3 className="text-xl font-semibold text-gray-700 mb-4">Practice Settings</h3>
        <form className="space-y-4">
          <div>
            <label htmlFor="practiceName" className="block text-gray-700 font-semibold mb-1">
              Practice Name
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="practicePhone" className="block text-gray-700 font-semibold mb-1">
              Phone
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="website" className="block text-gray-700 font-semibold mb-1">
              Website
            </label>
            <input
              type="url"
