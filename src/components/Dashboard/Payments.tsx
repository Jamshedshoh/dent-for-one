...
export const Payments = () => {
  ...
  const isPaymentExpanded = (paymentId: number) => expandedPayments.includes(paymentId);
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-semibold text-gray-800">Payments Management</h2>

      <div className="space-y-4">
        {payments.map((payment) => (
          <div key={payment.id} className="bg-white rounded-lg shadow-md overflow-hidden">
            {/* Payment Header */}
            <div 
              ...
              <div className="border-t border-gray-200">
                <div className="p-4 grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <p className="text-sm">
                        <span className="font-medium">User ID:</span> {payment.order.user_id}
                      </p>
                      <p className="text-sm">
